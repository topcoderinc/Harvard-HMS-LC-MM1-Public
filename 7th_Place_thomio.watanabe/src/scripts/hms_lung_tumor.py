...
class HMSLungTumor:
    ...
    def save_path_to_inference( self, path_to_files, file_name ):
    ...
    def save_file_with_imgs_paths( self, root_path, files_type ):
        ...
        for scan_id in all_scans_ids:
            ...
            tumor_numbers = self.read_structures_file( path_to_files, 'radiomics' )
    ...
    def convert_provisional_images( self, root_path ):
        ...
        for scan_id in all_scans_ids:
            ...
            for file_name in images_files:
                ...
                self.save_path_to_inference( path_to_files, file_name)
        return
    ...
    def show_gt( self, scan_path ):
        ...
        tumor_numbers = self.read_structures_file( scan_path, 'radiomics' )
